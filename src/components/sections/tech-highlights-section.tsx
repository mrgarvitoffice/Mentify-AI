                ...
                <div className="mt-16 grid grid-cols-1 gap-y-12 sm:grid-cols-2 lg:grid-cols-4 sm:gap-x-8 sm:gap-y-16">
                    {techFeatures.map((feature) => (
                        <div key={feature.title} className="flex flex-col items-center text-center">
                           <div className="flex items-center justify-center h-24 w-24 rounded-full bg-gradient-to-br from-primary/80 to-secondary/80 dark:from-primary/50 dark:to-secondary/50 text-white shadow-lg shadow-primary/20 dark:shadow-primary/10 animate-pulse-slow mb-6">
