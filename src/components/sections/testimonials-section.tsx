          ...
          <div className="-m-4 p-4">
             <div className="mx-auto max-w-6xl columns-1 gap-8 sm:columns-2 lg:columns-3">
                 {testimonials.map((testimonial, index) => (
                     <Card key={index} className="mb-8 break-inside-avoid rounded-2xl border-slate-200 bg-white p-6 shadow-lg transition-transform duration-300 hover:scale-105">
                         <CardContent className="p-0">
                             <blockquote className="text-gray-700">"{testimonial.quote}"</blockquote>
                             <figcaption className="mt-6 flex items-center gap-4">
                                 <Avatar className="h-12 w-12">
                                     <div className="flex h-full w-full items-center justify-center rounded-full bg-gradient-to-br from-purple-400 to-yellow-400 text-white font-bold">
